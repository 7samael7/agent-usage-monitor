...
pub use dto::{
    ...
    FxRow, HealthResponse, IngestProgress, IngestStatus, LatencySummary, MetaResponse, NewFxRate,
    NewPrice, Normalized, ObservedModel, PriceRow, PricingView, RequestCounts, SeriesPoint,
